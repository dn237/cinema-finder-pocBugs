...
const MapSnappingEventListener = () => {
  ...
  useEventListener("map.snapTo", ({ detail: { lat, lng } }) => {
    ...
    try {
      ...
      map.flyTo({
        center: [lng, lat],
        /*Fixed the “fly to cinema” issue in MapLibre. 
        The problem was caused by incorrect coordinate order ([lat, lng] instead of [lng, lat]) in map.flyTo(), which prevented navigation from working.
         */
        zoom: 16,
      });
    } catch (e) {
